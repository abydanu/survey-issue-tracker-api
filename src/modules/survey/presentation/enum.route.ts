...
import { getFilterEnumsRoute, getAllEnumsRoute, autoUpdateDisplayNamesRoute } from './enum.openapi.js';
...
export const createEnumRoutes = (enumController: EnumController) => {
  ...
  app.openapi(autoUpdateDisplayNamesRoute, enumController.autoUpdateDisplayNames as any);
